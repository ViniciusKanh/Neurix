// Canonical list of protectable pages / resources in Neurix.
// Used by the seed (admin gets all) and by the user-management UI.
// Keep in sync with src/lib/pages.js on the frontend.
export const PAGES = [
  ...
  { key: 'sequences', label: 'Padrões Sequenciais', path: '/sequences' },
